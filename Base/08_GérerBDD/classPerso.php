<?php
  ...
  class Personnages {
    ...
    // si on doit faire ça pour toutes les valeurs ça va être long et si on veut rajouter une
    // nouvelle variable il faudra l'ajouter manuellement.
    // pour éviter ça il faut faire comme ça :
    foreach ($donnees as $key => $value) {
      $method = 'set'.ucfirst($key);
      // il faut aussi vérifier si la méthode existe
